...
class LoginFromViewController: UIViewController {
    ...
    private func pushTabBar() {
        let tabBar = storyboardInstance.instantiateViewController(withIdentifier: "tabBarController")
        navigationController?.pushViewController(tabBar, animated: true)
    }
    
    private func showNextController() {
        let storyboardInstance = UIStoryboard(name: "Main", bundle: nil)
        let friendsController = storyboardInstance.instantiateViewController(withIdentifier: "friendsController")
